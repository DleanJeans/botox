        ...
        <View style={styles.sheet}>
          ...
          {selected.size > 0 && (
            <View style={styles.selectionBar}>
              <Text style={styles.selectionText}>{selected.size} role{selected.size > 1 ? 's' : ''} selected</Text>
              <Pressable
              ...
              return (
                <View key={team}>
                  <Text style={[styles.teamLabel, { color: TEAM_COLORS[team] }]}>
                    {team.charAt(0).toUpperCase() + team.slice(1)} ({filtered.length})
                  </Text>
                  <View
                    ...
                    {filtered.map(role => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Text style={[styles.roleName, isSelected && styles.roleNameSelected]} numberOfLines={1}>
                            {role.name}
                          </Text>
...
const styles = StyleSheet.create({
  ...
  sheet: {
    ...
    height: '90%', paddingTop: 16, paddingHorizontal: 20,
  ...
  nameInput: {
    backgroundColor: '#2f313a', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12,
    color: '#fff', fontSize: 15, marginBottom: 8,
  },
  searchInput: {
    backgroundColor: '#2a2c30', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8,
    color: '#fff', fontSize: 13, marginBottom: 12,
  },
  selectionBar: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    backgroundColor: '#3a2f1a', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, marginBottom: 12,
  },
  selectionText: { color: '#fcb93c', fontSize: 14, fontWeight: '600' },
  saveBtn: {
    backgroundColor: '#fcb93c', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 8,
  },
  ...
  roleCard: {
    ...
    backgroundColor: '#2f313a', borderRadius: 10, paddingVertical: 8, paddingHorizontal: 10,
    borderWidth: 1, borderColor: '#3a3c43',
  },
  roleCardSelected: {
    borderColor: '#fcb93c', backgroundColor: '#3a2f1a',
  },
  roleName: { color: '#ccc', fontSize: 16 },
  roleNameSelected: { color: '#fcb93c', fontWeight: '600' },
  checkmark: { color: '#fcb93c', fontSize: 12, fontWeight: '700' },
});
